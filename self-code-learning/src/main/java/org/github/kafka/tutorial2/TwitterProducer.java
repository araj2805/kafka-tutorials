...
public class TwitterProducer {
    ...
    private KafkaProducer<String, String> createKafkaProducer() {
        ...
        properties.setProperty(ProducerConfig.MAX_IN_FLIGHT_REQUESTS_PER_CONNECTION, "5"); // Kafka 2.0 >=1.1 so we keep it at 5 else 1

        // high throughput producer(at the expense of a bit latency nad CPU usage)
        properties.setProperty(ProducerConfig.COMPRESSION_TYPE_CONFIG, "snappy");
        properties.setProperty(ProducerConfig.LINGER_MS_CONFIG, "20");
        properties.setProperty(ProducerConfig.BATCH_SIZE_CONFIG, Integer.toString(1024 * 32)); // 32 KB Batch Size
